...
sample_topics_with_intentions = {
    "2학년 과학시간 - 숲 속의 동물": "의도: 숲 속에 사는 다양한 동물들의 모습을 설명하는 이미지를 생성하고자 하는 의도.",
    "2학년 체육시간 - 공원에서의 놀이": "의도: 공원에서 다양한 놀이 활동을 하는 모습을 생성하여, 학생들이 체육 활동의 재미를 느낄 수 있게 하고자 하는 의도.",
    "3학년 미술시간 - 문화 축제 장면": "의도: 문화 축제의 장면을 통해 학생들이 다양한 문화를 이해하도록 돕고자 하는 의도.",
    "3학년 사회시간 - 바닷가 풍경": "의도: 바닷가의 모습을 설명하고, 지리적 특성을 학생들에게 알려주는 이미지를 생성하고자 하는 의도.",
    "4학년 사회시간 - 자연재해 현장": "의도: 자연재해가 발생한 현장을 설명하는 이미지를 통해, 그 영향과 대비 방법을 설명하고자 하는 의도.",
    "4학년 역사시간 - 역사적인 건축물": "의도: 역사적인 건축물의 사진을 생성하여, 그 건축물의 의미와 건축 양식을 설명하고자 하는 의도.",
    "5학년 과학시간 - 과학 실험 장면": "의도: 과학 실험을 하는 장면을 시각화하여, 실험의 과정을 설명하고자 하는 의도.",
    "5학년 도덕시간 - 우리 주변에서 공중도덕을 어기는 모습": "의도: 공중도덕을 어기는 다양한 사례를 통해, 학생들에게 공중도덕의 중요성을 인식시키고자 하는 의도.",
    "5학년 사회시간 - 다양한 직업 사람들": "의도: 다양한 직업을 가진 사람들의 모습을 설명하는 이미지를 생성하고자 하는 의도.",
    "6학년 과학시간 - 우주 탐험": "의도: 우주 탐험을 설명하는 이미지를 생성하고, 우주에 대한 지식을 쉽게 설명하고자 하는 의도.",
    "6학년 역사시간 - 고대 유적지": "의도: 고대 유적지를 설명하는 이미지를 생성하고자 하는 의도."
}
